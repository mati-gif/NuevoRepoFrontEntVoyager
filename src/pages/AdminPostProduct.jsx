...
//           <ButtonWaveEffect text="Send Products" />
//         </form>
//       )}
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        icon: 'success',
        title: 'Succesfully',
        text: 'The products has been created succesfully',
    });
    } catch (error) {
      console.error("Error creating product:", error);
    }
        ...
        >
          ...
          <div className="mb-4">
            ...
            {/* <input
              ...
              required
            /> */}
            <FormattedNumberInput name="price" title="price" value={formData.price} onChange={handleChange} />
          </div>

...
const TablePB = ({ token }) => {
  ...
  <div className="flex flex-col justify-center items-center w-full lg:flex-row-reverse gap-[20px] lg:gap-[30px] mt-[20px]">
    <form className="w-[90%] lg:w-[50%] flex flex-col gap-[30px] lg:gap-[45px] items-center pt-[30px] lg:pt-[50px] relative">
      ...
      <button
        onClick={handleReservation}
        className="bg-yellow-500 hover:bg-yellow-600 p-4 lg:p-5 font-bold text-blue-950 rounded-xl w-full lg:w-auto"
      >
        Reserve
      </button>
      <p className="w-[90%] lg:w-[450px] text-yellow-500 text-[12px] lg:text-[14px] text-center lg:text-left">
        ...
        If you need to cancel your reservation, please do so with two hours'
        notice. Thank you for choosing us for your dining experience.
      </p>
    </form>
    ...
    <div className="bgTablePB border-2 border-yellow-500 relative h-[50vh] lg:h-[75vh] w-[90%] lg:w-[500px] rounded-xl">
      ...
      {groundFloorTables.map((table, index) => {
        ...
        switch (index) {
          case 0:
            customClass += " top-[7%] left-[7.5%] w-[10%] lg:w-[12%] h-[10%] lg:h-[12%]";
            break;
          case 1:
            customClass += " top-[15%] left-[23%] w-[20%] lg:w-[23%] h-[12%] lg:h-[14%]";
            break;
          case 2:
            customClass += " top-[31%] left-[16%] w-[10%] lg:w-[12%] h-[10%] lg:h-[12%]";
            break;
          case 3:
            customClass += " top-[47%] left-[13%] w-[10%] lg:w-[12%] h-[10%] lg:h-[12%]";
            break;
          case 4:
            customClass += " top-[61%] left-[18%] w-[10%] lg:w-[12%] h-[10%] lg:h-[12%]";
            break;
          case 5:
            customClass += " top-[71%] left-[8%] w-[10%] lg:w-[12%] h-[10%] lg:h-[12%]";
            break;
          case 6:
            customClass += " top-[81%] left-[18%] w-[10%] lg:w-[12%] h-[10%] lg:h-[12%]";
            break;
          case 7:
            customClass += " top-[71%] left-[28%] w-[10%] lg:w-[12%] h-[10%] lg:h-[12%]";
            break;
          case 8:
            customClass += " top-[70%] left-[59%] w-[10%] lg:w-[12%] h-[10%] lg:h-[12%]";
            break;
          case 9:
            customClass += " bottom-[7%] left-[68%] w-[10%] lg:w-[12%] h-[10%] lg:h-[12%]";
            break;
          case 10:
            customClass += " top-[46%] left-[72%] w-[10%] lg:w-[12%] h-[10%] lg:h-[12%]";
            break;
          case 11:
            customClass += " top-[60%] left-[68%] w-[10%] lg:w-[12%] h-[10%] lg:h-[12%]";
            break;
          case 12:
            customClass += " top-[70%] left-[79%] w-[10%] lg:w-[12%] h-[10%] lg:h-[12%]";
            break;
          case 13:
            customClass += " top-[31%] left-[71%] w-[10%] lg:w-[12%] h-[10%] lg:h-[12%]";
            break;
          case 14:
            customClass += " top-[14%] left-[65%] w-[20%] lg:w-[22%] h-[13%] lg:h-[15%]";
            break;
          default:
            customClass += " top-[30%] left-[70%] w-[16%] lg:w-[18%] h-[13%] lg:h-[15%]";
        }
        ...
        return (
          <div
            ...
            className={`${customClass} text-black hover:text-white`}
          >
            <p>{table.id}</p>
            <p>
              {table.seats} <i className="fa-solid fa-chair"></i>{" "}

...
function TimeInfoComponent() {
    ...
    return (
        <div className="happy-hours-container flex flex-col lg:flex-row" ref={containerRef}>
            <div className="left-side-container-time-info flex-1 p-4">
                <div className="image-overlay-container-time-info">
                    {/* <h2>Happy Hours</h2> */}
            ...
            <div className="right-side-container-time-info flex-1 p-4">
                <div className="content-time-info">
                    <h3 className="h3-container-time-info text-center">¡We are waiting for you!</h3>
                    <h2 className="h2-container-time-info text-center">OUR SCHEDULES</h2>
                    <div className="schedule-container-time-info flex flex-col sm:flex-row sm:justify-around">
                        <div className="location-container-time-info text-center">
                            <h4>New York</h4>
                            <p>20:00</p>
                            <p>02:00</p>
                        </div>
                        <div className="divider-container-time-info hidden sm:block w-0.5 bg-gray-300 mx-2"></div>
                        <div className="location-container-time-info text-center">
                            <h4>Miami</h4>
                            <p>20:00</p>
                            <p>02:00</p>

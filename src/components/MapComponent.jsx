...
function MapComponent() {
    return (
        <div className=' border-green-500 border-4  '>
            ...
            <div className='border-4 border-red-700 w-[80%] flex flex-col justify-between  m-auto  md:flex-row'>
                <div className='border-4 border-yellow-500  flex flex-col     '>
                ...
                <div className='border-4 border-purple-500 flex flex-col '>
